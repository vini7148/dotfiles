# Generated by Powerlevel10k configuration wizard on 2020-11-17 at 17:48 IST.
# Based on romkatv/powerlevel10k/config/p10k-classic.zsh, checksum 49789.
# Wizard options: flat, large icons, classic, unicode, light, 24h time, blurred heads,
# blurred tails, 2 lines, dotted, full frame, sparse, many icons, fluent,
