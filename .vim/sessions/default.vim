...
inoremap <silent> <expr> <Plug>(coc-calc-result-replace) coc#_insert_key('request', 'calc-result-replace', 1)
inoremap <silent> <expr> <Plug>(coc-calc-result-append) coc#_insert_key('request', 'calc-result-append', 1)
...
nmap ,ev :NERDTree ~/.config/nvim
vnoremap ,64 y:let @"=system('base64 --decode', @")gvP
vnoremap <silent> ,tr :TranslateReplace
vnoremap <silent> ,tt :TranslateVisual
nnoremap <silent> ,tt :Translate
nmap ,A :EasyAlign
vmap ,A :EasyAlign
...
noremap ,gc :Gcommit
noremap ,ga :Gwrite
noremap ,qo :call buffer#DeleteOnly()
noremap ,qa :bufdo bd!
noremap ,qq :bufdo bd
noremap ,q :bp:bd #
nnoremap =op <Nop>
...
nnoremap <silent> <Plug>(coc-calc-result-replace) :call coc#rpc#request('doKeymap', ['calc-result-replace'])
nnoremap <silent> <Plug>(coc-calc-result-append) :call coc#rpc#request('doKeymap', ['calc-result-append'])
...
noremap <F3> :lcd %:p:h:NERDTreeCWD
noremap <C-Bslash> :NERDTreeToggle
...
noremap <M-h> :bp
noremap <M-Left> :bn
noremap <C-Up> :resize +5
noremap <C-Right> :vertical resize -5
noremap <C-Down> :resize -5
noremap <C-Left> :vertical resize +5
imap S <Plug>ISurround
imap s <Plug>Isurround
imap <NL> <Plug>(coc-snippets-ecpand-jump)
imap  <Plug>(coc-snippet-expand)
inoremap <expr>  pumvisible() ? "\" : "\u\"
imap  <Plug>Isurround
...
set report=0
set ruler
set runtimepath=~/.vim,~/.vim/plugged/vim-airline,~/.vim/plugged/nerdtree,~/.vim/plugged/auto-pairs,~/.vim/plugged/tagbar,~/.vim/plugged/syntastic,~/.vim/plugged/vim,~/.vim/plugged/tabular,~/.vim/plugged/vim-markdown,~/.vim/plugged/indentLine,~/.vim/plugged/vim-devicons,~/.vim/plugged/coc.nvim,~/.fzf,~/.vim/plugged/fzf.vim,~/.vim/plugged/vim-fugitive,~/.vim/plugged/vim-commentary,~/.vim/plugged/vim-surround,~/.vim/plugged/vim-unimpaired,~/.vim/plugged/gruvbox-cyberpunk,~/.vim/plugged/vim-gitgutter,~/.vim/plugged/coc-sources,~/.vim/plugged/onedark.vim,~/.vim/plugged/rust.vim,~/.vim/plugged/vim-easy-align,~/.vim/plugged/Colorizer,~/.vim/plugged/vim-go,~/.vim/plugged/vim-autoformat,/var/lib/vim/addons,/etc/vim,/usr/share/vim/vimfiles,/usr/share/vim/vim81,/usr/share/vim/vimfiles/after,/etc/vim/after,/var/lib/vim/addons/after,~/.vim/plugged/vim/after,~/.vim/plugged/tabular/after,~/.vim/plugged/vim-markdown/after,~/.vim/plugged/indentLine/after,~/.vim/plugged/rust.vim/after,~/.vim/after,~/.config/coc/extensions/node_modules/coc-snippets
set scrolloff=5
set shiftround
set shiftwidth=4
...
silent only
silent tabonly
cd /media/vinayak/Extreme\ SSD/dotfiles
...
unlet! s:wipebuf
set winheight=1 winwidth=20 shortmess=atToOc
